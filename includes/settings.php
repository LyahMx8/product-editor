...
class Settings{
	...
	private function load_dependencies() {
		...
		//La clase que guarda imagenes simples
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/saveImage.php';
	...
	private function define_function_hooks(){
		...
		$this->loader->add_action('wp_head', $plugin_functions, 'loadFacebook');
